...
<!-- =======================
헤더 시작 -->
<header class="header-static border-bottom" style="z-index: 1060; position: fixed; width: 100%; top: 0;">
    <!-- 상단 헤더 -->
...
<!-- 메인 네비게이션 부분 시작 -->
<header class="border-bottom" style="position: fixed; width: 100%; top: 50px; z-index: 1060;">
    <!-- 하단 헤더 (메인 네비게이션) -->
