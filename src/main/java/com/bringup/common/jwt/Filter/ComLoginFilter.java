...
public class ComLoginFilter extends UsernamePasswordAuthenticationFilter {

    private final AuthenticationManager authenticationManager;
    //JWTUtil 주입
    private final JWTUtil jwtUtil;

    public ComLoginFilter(AuthenticationManager authenticationManager, JWTUtil jwtUtil) {
