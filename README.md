...
![TOP 100 공고](https://github.com/user-attachments/assets/e8b5f3f3-45d5-4e2e-8dc5-4f08de3c9140)
- **TOP100 공고** :  
현재 사이트에서 가장 인기가 많은 공고 100가지를 출력  
...
![깃 레파지토리](https://github.com/user-attachments/assets/249a62c2-740e-4c7d-af42-6e2046e9d02a)
- **깃 레파지토리** :  
...
![사용자 프로필](https://github.com/user-attachments/assets/2cc3180b-1363-4090-969f-8fc983d2dacb)
- **사용자 프로필** :  
 사용자가 등록한 사용자 정보를 폼에 출력  

![내가 본 공고](https://github.com/user-attachments/assets/fd9829ea-cf7c-498a-8c72-77a2baca56f1)
- **내가 본 공고** :  
 사용자가 방문한 공고를 리스트 형태로 출력  
 본 공고를 10개씩 출력되도록 구현  
 리스트에 해당 방문한 공고 클릭 시 해당 공고의 상세페이지로 이동  

![지원한 공고](https://github.com/user-attachments/assets/9de1ac4b-6590-44e7-8c30-3e56c0f8e399)
- **지원한 공고** :  
 사용자가 지원한 공고를 리스트 형태로 출력  
 리스트에 해당 지원한 공고 클릭 시 해당 공고의 상세 페이지로 이동  
 현재 지원한 공고의 총 수와 합격, 불합격한 공고 수 출력되도록 구현  

![기업 북마크](https://github.com/user-attachments/assets/e66f38af-8f96-4fd6-ab69-5d10d58aa1cc)
- **기업 북마크** :  
 사용자가 북마크한 기업을 리스트 형태로 출력  
 기업 상세페이지에서 북마크 버튼 클릭 시 해당 기업 저장  
 저장된 기업 정보를 리스트 형태로 출력되도록 구현  

![게시글 목록](https://github.com/user-attachments/assets/36e678f1-2434-4474-9c28-a8fcbed3c06c)
- **게시글 목록** :  
 모든 사용자가 작성한 게시글을 리스트 형태로 출력  
 저장된 게시글 정보를 리스트 형태로 출력되도록 구현  
 리스트에 해당 게시글 클릭 시 게시글 상세 페이지로 이동  

![게시글 작성](https://github.com/user-attachments/assets/ed1a095f-2d84-44f1-8a60-ca8568393287)
- **게시글 작성** :  
 일반 회원으로 가입된 사용자가 게시글을 작성 및 등록할 수 있는 페이지  
 사용자가 폼에 맞게 제목, 이미지, 내용을 작성하여 등록  
